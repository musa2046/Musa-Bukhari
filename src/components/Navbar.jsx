        ...
        <>
            <nav className="navbar navbar-expand-lg  p-0" style={{maxHeight:"5vh"}} >
                <div className="container-fluid ">
                    ...
                    <a href="#" className="navbar-brand d-flex align-items-center p-0 "><img style={{ height: "3vw", maxHeight: "5vw",minHeight:"40px", width: "auto" }} className="img-fluid " alt="logo" src={navLogo}></img></a>
